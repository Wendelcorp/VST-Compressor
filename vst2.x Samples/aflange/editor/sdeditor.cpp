...
bool SDEditor::open (void *ptr)
{
	...
	delayOption->addEntry("0 ms");
	delayOption->addEntry("0.1 ms");
	delayOption->addEntry("0.2 ms");
	delayOption->addEntry("0.5 ms");
	delayOption->addEntry("1 ms");
	delayOption->addEntry("2 ms");
	delayOption->addEntry("5 ms");
